...
public class NormalParkourModModItems {
	...
	public static final RegistryObject<Item> KILL_BRICK = block(NormalParkourModModBlocks.KILL_BRICK,
			NormalParkourModModTabs.TAB_MAD_MINCRAFTR_PARKOUR);
	...
	public static final RegistryObject<Item> JUMP_BLOCK = block(NormalParkourModModBlocks.JUMP_BLOCK,
			NormalParkourModModTabs.TAB_MAD_MINCRAFTR_PARKOUR);
