 ...
 *
 */
package net.mincraftr.normal_parkour;
...
@Mod("normal_parkour_mod")
public class NormalParkourModMod {
	public static final Logger LOGGER = LogManager.getLogger(NormalParkourModMod.class);
	public static final String MODID = "normal_parkour_mod";
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation(MODID, MODID), () -> PROTOCOL_VERSION,
			PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	private static int messageID = 0;

	public NormalParkourModMod() {
		NormalParkourModModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		NormalParkourModModBlocks.REGISTRY.register(bus);
		NormalParkourModModItems.REGISTRY.register(bus);
