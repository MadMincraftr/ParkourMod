...
package net.mincraftr.parkour.client.gui;
...
public class SuperBlockConfigScreen extends AbstractContainerScreen<SuperBlockConfigMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("madmincraftrs_parkour_mod:textures/super_block_config.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "[ THIS GUI IS BROKEN ); ]", 77, 109, -1163714);
	}
