...
import net.mincraftr.parkour.procedures.ZeroGravityEffectStartedProcedure;
import net.mincraftr.parkour.procedures.ZeroGravityEffectExpiresProcedure;
...
public class ZeroGravityMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.madmincraftrs_parkour_mod.zero_gravity";
	}
