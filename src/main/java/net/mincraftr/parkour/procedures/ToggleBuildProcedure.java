...
public class ToggleBuildProcedure {
	public static void execute(Entity entity) {
		...
		if (new Object() {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("You need to be in creative or adventure for this command to work."), (false));
		}
	}
}
